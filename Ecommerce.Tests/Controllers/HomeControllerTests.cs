...
namespace Ecommerce.Tests.Controllers
{
    public class HomeControllerTests
    {
        ...
        /// then should redirect to home/index route with tempdata[successmessage]
        /// </summary>
        [Fact]
        public async Task ForgotPassword_Post_SuccessfulResponse_RedirectsToHome()
        {
            // Arrange
        ...
        /// if token is null then redirect to route /home/forgotpassword/ 
        ...
        /// then redirect to /home/forgotpassword route with tempdata[errormessage]
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Reset password get method : Case
        /// if exception occures then it should redirect to /home/forgotpassword with
        ...
        public async Task ResetPassword_Post_SuccessfulResponse_RedirectsToIndex()
        {
            ...
            RedirectToActionResult redirectResult = Assert.IsType<RedirectToActionResult>(result);
            Assert.Equal("Index", redirectResult.ActionName);
            Assert.Null(redirectResult.ControllerName); // Same controller (Home)
